...
public class DaysBetweenItem implements Item{
	...
	@Override
	public void perform() {
		LocalDate date1 = inOut.inputDate("Enter first date in format yyyy-MM-dd ", "yyyy-MM-dd");
		if(date1 == null) return;
		LocalDate date2 = inOut.inputDate("Enter second date in format yyyy-MM-dd ", "yyyy-MM-dd");
